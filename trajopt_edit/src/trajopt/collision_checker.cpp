...
boost::shared_ptr<CollisionChecker> CollisionChecker::GetOrCreate(planning_scene::PlanningScenePtr env) {
...
void CollisionChecker::IgnoreZeroStateSelfCollisions(MoveitKinBodyPtr body) {
  LOG_DEBUG("IgnoreZeroStateSelfCollisions for %s", body->GetName().c_str());
