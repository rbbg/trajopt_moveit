...
TrajOptProbPtr TRAJOPT_API ConstructProblem(const Json::Value&, planning_scene::PlanningScenePtr env);
...
public:
  ...
  planning_scene::PlanningScenePtr GetEnv() {return m_rad->GetEnv();}
...
public:
  ...
  ProblemConstructionInfo(planning_scene::PlanningScenePtr _env) : env(_env) {}
